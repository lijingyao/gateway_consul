package com.lijingyao.gateway.consul.api.adapter;

import com.lijingyao.gateway.consul.api.base.GatewayErrors;
import com.lijingyao.gateway.consul.api.base.RestExceptionHandler;
import com.lijingyao.gateway.consul.api.base.Result;
import com.lijingyao.gateway.consul.api.translator.ItemTranslator;
import com.lijingyao.gateway.consul.api.translator.OrderTranslator;
import com.lijingyao.gateway.consul.api.assemblers.OrderAssembler;
import com.lijingyao.gateway.consul.api.models.OrderCreateDetailModel;
import com.lijingyao.gateway.consul.api.models.OrderCreateModel;
import com.lijingyao.gateway.consul.api.models.OrderModel;
